...
const Learn = ({ topicName, highLevelOverview, youtubeLink }) => {
  ...
  const [chatLogs, setChatLogs] = useState([
    ["Can be verified on any platform using docker.", "Gemini"],
    ["Your error message says permission denied, npm global installs must be given root privileges.", "User"]
  ]);
  ...
  return (
    <div className="flex h-screen">
      {/* Chat Section */}
      <div className="w-1/3 flex flex-col p-2 sm:p-6 justify-between border-r-2 border-gray-200">
